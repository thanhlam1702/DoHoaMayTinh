...
//void idleFunc(void);
//void reshapeFunc(int width, int heigh);
...
//// position of the mouse whenpressed
...
//	//gluLookAt (viewerPosition[0], viewerPosition[1], viewerPosition[2], viewerDirection[0],viewerDirection[1],viewerDirection[2], viewerUp[0],viewerUp[1],viewerUp[2]);
//	glLoadIdentity();
...
//	cframe++;
//	if (time - timebase > 50) {
//		printf("fps : %4.2f", cframe*1000.0 / (time - timebase));
//		timebase = time;
//		cframe = 0;
//	}
//	glPushMatrix();
